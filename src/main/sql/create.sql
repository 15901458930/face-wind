...
DROP TABLE IF EXISTS `SY_USER`;
 CREATE TABLE `SY_USER` (
  `ID` varchar(255) NOT NULL PRIMARY KEY COMMENT '微信认证后的USER_ID',
  ...
  `USER_TYPE` tinyint(4) DEFAULT NULL COMMENT '用户类型 1.管理员  2.老师 3.维修 4.无类型',
...
CREATE TABLE `FIX_ASSET_TASK` (
  ...
  `FIX_USER_ID` varchar(255) DEFAULT NULL COMMENT '负责修理用户ID',
  `APPLY_USER_ID` varchar(255)  NOT NULL COMMENT '发起申请用户ID',
...
CREATE TABLE `BOOK_ROOM_TASK` (
  ...
  `BOOK_USER_ID` varchar(255)  DEFAULT NULL COMMENT '预订人',
...
insert into SY_ROOM VALUES(3,'东区三类小会议室','','2018-04-01 18:55:55');
